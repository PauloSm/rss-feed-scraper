...
class GizmodoParser(BaseParser):
    """Class used to represent the Gizmodo parser. Inherits from BaseParser
    ...
    def __init__(self):
        super().__init__()
        self.website_url = "https://es.gizmodo.com"
        self.rss_link_element = "a"
        self.rss_link_attr_name = "data-ga"
        self.rss_link_attr_value = '[["Network navigation","Social button click","rss",{"metric21":1}]]'
