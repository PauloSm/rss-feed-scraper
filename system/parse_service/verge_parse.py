...
class VergeParser(BaseParser):
    """Class used to represent the Verge parser. Inherits from BaseParser
    ...
    def __init__(self):
        super().__init__()
        self.website_url = "https://www.theverge.com"
        self.rss_link_element = "a"
        self.rss_link_attr_name = "class"
        self.rss_link_attr_value = "rss"
    ...
    def get_rss_link(self, page_content) -> Union[str, None]:
        ...
        if element:
            try:
                return self.website_url + element["href"]
