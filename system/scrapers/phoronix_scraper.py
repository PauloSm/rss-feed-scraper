...
from system.parse_service.phoronix_parse import PhoronixParser


class PhoronixScraper:
    """
    Class used to represent the Phoronix scraper.
    ...
    def __init__(self):
        self.url = "https://www.phoronix.com"
        self.html_page = bytes()
        self.rss_link = str()
        self.rss_page = bytes()
        self.parser = PhoronixParser()
